  ...
  _createClass(ResourceTreeComponent, [{
    ...
    value: function addInput(input, container) {
      ...
      if (this.choices.input && this.choices.input.element) {
        this.addEventListener(this.choices.input.element, 'focus', function (e) {
          if (e.target === _this5.choices.input.element) {
            _this5.choices.input.element.blur();
          }
        });
      }
      ...
      this.addEventListener(input, 'removeItem', function (event) {
