  ...
  _createClass(ResourceTreeComponent, [{
    ...
    value: function asString(value) {
      ...
      return value.map(function (v) {
        return _lodash.default.default.get(v, _this2.component.titleAttribute);
      }).join(', ');
    }
  }, {
    key: "getValue",
    ...
    value: function nodeUnchecked(node) {
      ...
      this.visitNodesInChoices(nodesToRemove, choiceValues, function (treeNode, choiceVal) {
        _this7.choices.removeItemsByValue(choiceVal.value);
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                return _context3.abrupt("return", _Formio.default.makeStaticRequest(finalUrl, 'GET').then(function (res, err) {
                  ...
                  _this9.treeData = _this9.handleTreeResponse(res);
                  return _this9.treeData;
                }));
        ...
        if (node.nodes) {
          node.nodes.forEach(function (child) {
            if (child.state.checked === true) {
              ...
              _this10.uncheckNodeAndMaybeSubtree(child, tree, modifiedChildren, unmodifiedChildren);
            } else {
        ...
        if (node.nodes) {
          node.nodes.forEach(function (child) {
            if (child.state.checked === false) {
              ...
              _this11.checkNodeAndMaybeSubtree(child, tree, modifiedChildren, unmodifiedChildren);
            } else {
              unmodifiedChildren.push(child);
            }
          });
