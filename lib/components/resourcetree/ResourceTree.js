  ...
  _createClass(ResourceTreeComponent, [{
    ...
    value: function setValue(value) {
      ...
      if (!value || Array.isArray(value) && value.length === 0) {
        _get(_getPrototypeOf(ResourceTreeComponent.prototype), "setValue", this).call(this, []);
    ...
    value: function addInput(input, container) {
      ...
      this.appendTreeTo(div).then(function (treeDiv, err) {
        if (!_this4.component.inlineTree) {
          ...
          var tags = div.querySelector("#".concat(_this4.component.id, "-tags"));
    ...
    value: function nodeChecked(node) {
      ...
      if (currentValues.length === 0) {
        ...
        _get(_getPrototypeOf(ResourceTreeComponent.prototype), "setValue", this).call(this, _toConsumableArray(this.removeNodesFromChoices(nodesToRemove, currentValues)).concat([newVal]));
    ...
    value: function prepareTreeAttributes(response) {
      ...
      if (Array.isArray(response)) {
        ...
        response.forEach(function (v) {
          result.push(_this7.prepareTreeAttributes(v));
        });
        return result;
      }
