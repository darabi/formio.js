    ...
    value: function addInput(input, container) {
      ...
      var callbackOnUnknownChoice = function callbackOnUnknownChoice(value, hasShift) {
        ...
        form.on('submit', function (submission) {
          ...
          _this6.setChoices([newItem], 'value', 'label', false); // alternative:
          ...
          _this6.clearInput(); // not sure how this relates to the task at hand:
      ...
      var added = values.reduce(function (defaultAdded, value) {
        ...
        if (items && items.length) {
          _lodash.default.each(items, function (choice) {
            ...
            found |= _lodash.default.isEqual(_this7.itemValue(choice, isSelectOptions), value);
