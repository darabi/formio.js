        ...
        Array.prototype.forEach.call(files, function (file) {
          ...
          if (fileUpload.status !== 'error') {
            ...
            if (fileService.uploadsInProgress === undefined) {
              ...
              var submitButton = _this13.root.element.querySelector('.formio-component-submit').querySelector('button');
            ...
            uploadsInProgress.add(_this13); //uploadsInProgress.report();
            //
            ...
            fileService.uploadFile(storage, file, fileName, dir, function (evt) {
              ...
              _this13.refreshDOM(); // Track uploads in progress.


              uploadsInProgress.remove(_this13); //uploadsInProgress.report();
              //
